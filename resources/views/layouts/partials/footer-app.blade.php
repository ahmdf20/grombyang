                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="axil-footer-widget footer-widget-newsletter">
                            ...
                            <p>Subscribe to our newsletter and get <span>20% discount</span> offer in your first
                                order</p>
                ...
                <div class="col-lg-8">
                    <div class="payment-method">
                        ...
                        <ul class="payment-icons">
                            <li><img
                                    src="{{ asset('etrade') }}/assets/images/icons/cart/cart-1.png"
                                    alt="paypal cart"
                                ></li>
                            <li><img
                                    src="{{ asset('etrade') }}/assets/images/icons/cart/cart-2.png"
                                    alt="paypal cart"
                                ></li>
                            <li><img
                                    src="{{ asset('etrade') }}/assets/images/icons/cart/cart-3.png"
                                    alt="paypal cart"
                                ></li>
                            <li><img
                                    src="{{ asset('etrade') }}/assets/images/icons/cart/cart-4.png"
                                    alt="paypal cart"
                                ></li>
                            <li><img
                                    src="{{ asset('etrade') }}/assets/images/icons/cart/cart-5.png"
                                    alt="paypal cart"
                                ></li>
                        </ul>
                    </div>
    ...
    <div class="copyright-area copyright-default">
        <div class="container">
            <div class="copyright-left d-flex flex-wrap justify-content-center">
                ...
                <ul class="quick-link">
                    <li>© 2023. All rights reserved by <a
                            target="_blank"
