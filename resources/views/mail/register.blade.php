                        ...
                        <tbody>
                            <tr>
                                <td style="padding:48px 0 30px 0; text-align: center; font-size: 14px; color: #4C83EE;">
                                    <img
                                        src="https://mailsend-email-assets.mailtrap.io/gs3i26bcjcmxx35m7xczx4aj4423.png" />
                                </td>
                            </tr>
                            <tr>
                                <td
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Thanks for registring to our website grombyang!
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                            ...
                                            <tr>
                                                <td style="padding: 0 0 24px 0;">
                                                    <a
                                                        class="button"
                                                        href="{{ config('app.url') }}/{{ $url }}/{{ $user->id }}/{{ $token->token }}/{{ $token->method }}"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Best regards, <br><strong>Grombyang Team</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td style="padding: 24px 0 48px; font-size: 0px;">
                                    ...
                                    >
                                        ...
                                        >&copy; Grombyang {{ date('Y') }}<br />Jl. Rusa I No.57, Nagri Kidul, Kec.
                                            Purwakarta, Kabupaten Purwakarta, Jawa Barat 41111</span>
                                    </div>
