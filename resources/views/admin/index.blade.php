                        ...
                        >
                            <ul class="nk-block-tools g-3">
                                ...
                                <li class="nk-block-tools-opt">
                                    ...
                                    ><em class="icon ni ni-plus"></em><span>Add Admin</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <ul class="link-list-opt">
                                                    <li><a
                                                            href="{{ route('admin.edit-password', ['uuid' => $user->uuid]) }}"><span>Change
                                                                Password</span></a>
                                                    </li>
                                                    <li><a
                                                            href="{{ route('admin.edit', ['uuid' => $user->uuid]) }}"><span>Edit</span></a>
                                                    </li>
                                                    <li><a
                                                            href="#"
    ...
    function handleDelete(uuid) {
        ...
        confirmButtonText: "Yes, delete it!"
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `{{ config('app.url') }}/admin/delete/${uuid}`,
                    method: 'POST',
                    data: {
                        _method: 'DELETE',
                        _token: `{{ csrf_token() }}`
