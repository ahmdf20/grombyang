                        ...
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img
                                    ...
                                    src="{{ asset('etrade') }}/assets/images/product/electric/product-05.png"
                                    alt="Product Images"
                                >
                            </a>
                        ...
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img
                                    ...
                                    data-sal-delay="300"
                                    data-sal-duration="500"
                                    src="{{ asset('etrade') }}/assets/images/product/electric/product-06.png"
                                    alt="Product Images"
                                >
                            </a>
                        </div>
                        ...
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img
                                    ...
                                    data-sal-delay="400"
                                    data-sal-duration="500"
                                    src="{{ asset('etrade') }}/assets/images/product/electric/product-07.png"
                                    alt="Product Images"
                                >
                            </a>
                            <div class="label-block label-right">
                        ...
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img
                                    ...
                                    data-sal-delay="500"
                                    data-sal-duration="500"
                                    src="{{ asset('etrade') }}/assets/images/product/electric/product-08.png"
                                    alt="Product Images"
                                >
                            </a>
                            <div class="label-block label-right">
                        ...
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img
                                    ...
                                    data-sal-delay="100"
                                    data-sal-duration="500"
                                    src="{{ asset('etrade') }}/assets/images/product/electric/product-04.png"
                                    alt="Product Images"
                                >
                            </a>
                            <div class="label-block label-right">
