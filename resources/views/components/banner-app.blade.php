            ...
            <div class="col-md-6">
                <div class="slide-thumb-area">
                    <div class="main-thumb">
                        <img
                            src="{{ asset('etrade') }}/assets/images/banner/women_sunglass.png"
                            alt="Women's Product"
                        >
                    </div>
                        ...
                        <li class="shape-1">
                            ...
                            >
                                <path
                                    ...
                                    stroke="url(#paint0_linear_3774_13416)"
                                    stroke-width="32"
                                    stroke-linecap="round"
                                />
                                <defs>
                                    <linearGradient
                                        id="paint0_linear_3774_13416"
                                        x1="359.308"
                                        y1="-263.741"
                                        x2="-235.553"
                                        y2="631.772"
                            ...
                            >
                                <g clip-path="url(#clip0_1478_3882)">
                                    <path
                                        ...
                                        stroke="url(#paint0_linear_1478_3882)"
                                        stroke-width="32"
                                        stroke-linecap="round"
                                    />
                                </g>
